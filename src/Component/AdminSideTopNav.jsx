        ...
        <>
            <div className="h-30vh w-[100%] p-2 bg-white dark:bg-slate-700 flex flex-row items-center justify-end md:justify-between shadow-md shadow-gray-500 dark:shadow-none">
                ...
                <div className="other px-4 flex flex-row gap-4 items-center justify-between">
                    <svg xmlns="http://www.w3.org/2000/svg" width="65" height="65" viewBox="0 0 24 24" className="text-black dark:text-slate-400 cursor-pointer">
                    ...
                    <div className='w-full flex flex-row gap-4 items-center justify-center'>
                        <h1 className='text-lg font-bold text-violet-700 dark:text-white'>{userData.name}</h1>
                    </div>
                </div>
            </div>
        </>
...
export default AdminSideTopNav