...
const Sidebar = () => {
    ...
    return (
        <>
            <div className={`h-full px-2 py-5 bg-white dark:bg-slate-700 shadow-lg  shadow-gray-500 dark:shadow-none ${menuOpen ? 'w-[38vh] absolute md:relative' : 'w-[10vh]'}`}>
                ...
                <div className="p-2 w-full overflow-hidden">
                    <a href="/HODCertApproval" className="flex flex-row items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" className="text-violet-600 dark:text-slate-500 cursor-pointer">
                        ...
                        <span className={`px-4 text-md font-bold text-black hover:text-violet-600 dark:text-white dark:hover:text-violet-600 ${menuOpen ? 'block' : 'hidden'}`}>Document Approval</span>
                    </a>
                </div>
